...
class GRU4RecRecommender(BasicRecommender_soft):
    ...
    def trainEachBatch(self, epochId, batchId):
        ...
        self.optimizer.run(feed_dict={
            ...
            self.input_seq_rating_holder: input_rating_batch,
            self.target_seq_rating_holder: target_rating_batch,
    ...
    def getTrainData(self, batchId):
        ...
        return input_seq_batch, pos_seq_batch, neg_seq_batch, input_rating_batch, target_rating_batch
